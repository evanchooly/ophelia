package com.antwerkz.ophelia.dropwizard;
 ...
 */
public class DevelopmentAssetsBundle implements Bundle {
    private static final Logger LOGGER = LoggerFactory.getLogger(DevelopmentAssetsBundle.class);
     ...
     *
     * @see com.antwerkz.ophelia.dropwizard.DevelopmentAssetsBundle#AssetsBundle(String, String, String)
     */
    public DevelopmentAssetsBundle() {
     ...
     * @see com.antwerkz.ophelia.dropwizard.DevelopmentAssetsBundle#AssetsBundle(String, String, String)
     */
    public DevelopmentAssetsBundle(String path) {
     ...
     * @see com.antwerkz.ophelia.dropwizard.DevelopmentAssetsBundle#AssetsBundle(String, String, String)
     */
    public DevelopmentAssetsBundle(String resourcePath, String uriPath) {
     ...
     */
    public DevelopmentAssetsBundle(String resourcePath, String uriPath, String indexFile) {
     ...
     */
    public DevelopmentAssetsBundle(String resourcePath, String uriPath, String indexFile, String assetsName) {
    ...
    private DevelopmentAssetServlet createServlet() {
        return new DevelopmentAssetServlet(resourcePath, uriPath, indexFile, Charsets.UTF_8);
    }
}
