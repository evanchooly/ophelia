...
public class DevelopmentAssetServlet extends HttpServlet {
     ...
     */
    public DevelopmentAssetServlet(String resourcePath,
                                   String uriPath,
                                   String indexFile,
    ...
    private CachedAsset loadAsset(String key) throws URISyntaxException, IOException {
        ...
        File resource = new File("src/main/resources", absoluteRequestedResourcePath);
        URL requestedResourceURL = resource.toURI().toURL();
        if (resource.isDirectory()) {
            if (indexFile != null) {
                resource = new File("src/main/resources", absoluteRequestedResourcePath + '/' + indexFile);
                requestedResourceURL = resource.toURI().toURL();
            } else {
        ...
        return new CachedAsset(Resources.toByteArray(requestedResourceURL), System.currentTimeMillis());
    }
}
