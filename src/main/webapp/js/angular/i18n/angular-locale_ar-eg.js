angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"NUMBER_FORMATS":{"DECIMAL_SEP":",", "GROUP_SEP":".", "PATTERNS":[
            ...
            "ص", "م"
        ], "medium":"dd‏/MM‏/yyyy h:mm:ss a", "short":"d‏/M‏/yyyy h:mm a", "fullDate":"EEEE، d MMMM، y", "longDate":"d MMMM، y", "mediumDate":"dd‏/MM‏/yyyy", "shortDate":"d‏/M‏/yyyy", "mediumTime":"h:mm:ss a", "shortTime":"h:mm a"}, "id":"ar-eg"});
    }
]);