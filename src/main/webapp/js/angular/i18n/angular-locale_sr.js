angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"DATETIME_FORMATS":{"MONTH":[
        ...
        ], "SHORTMONTH":["јан", "феб", "мар", "апр", "мај", "јун", "јул", "авг", "сеп", "окт", "нов", "дец"], "DAY":[
            "недеља", "понедељак", "уторак", "среда", "четвртак", "петак", "субота"
        ], "SHORTDAY":["нед", "пон", "уто", "сре", "чет", "пет", "суб"], "AMPMS":[
            "пре подне", "поподне"
        ], "medium":"dd.MM.y. HH.mm.ss", "short":"d.M.yy. HH.mm", "fullDate":"EEEE, dd. MMMM y.", "longDate":"dd. MMMM y.", "mediumDate":"dd.MM.y.", "shortDate":"d.M.yy.", "mediumTime":"HH.mm.ss", "shortTime":"HH.mm"}, "NUMBER_FORMATS":{"DECIMAL_SEP":".", "GROUP_SEP":",", "PATTERNS":
            [
            ...
            ], "CURRENCY_SYM":"РСД"}, "pluralCat":function (n) {
            if ((n % 10) == 1 && (n % 100) != 11) {
            ...
            if ((n % 10) == 0 || ((n % 10) >= 5 && (n % 10) <= 9) || ((n % 100) >= 11 && (n % 100) <= 14) && n
                == Math.floor(n)) {
