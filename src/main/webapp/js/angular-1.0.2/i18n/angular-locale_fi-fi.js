angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"NUMBER_FORMATS":{"DECIMAL_SEP":",", "GROUP_SEP":" ", "PATTERNS":[
            ...
            "ap.", "ip."
        ], "medium":"d.M.yyyy H.mm.ss", "short":"d.M.yyyy H.mm", "fullDate":"cccc d. MMMM y", "longDate":"d. MMMM y", "mediumDate":"d.M.yyyy", "shortDate":"d.M.yyyy", "mediumTime":"H.mm.ss", "shortTime":"H.mm"}, "id":"fi-fi"});
    }
]);