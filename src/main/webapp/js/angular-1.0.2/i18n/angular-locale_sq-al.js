angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        ], "SHORTMONTH":["Jan", "Shk", "Mar", "Pri", "Maj", "Qer", "Kor", "Gsh", "Sht", "Tet", "Nën", "Dhj"], "DAY":[
            "e diel", "e hënë", "e martë", "e mërkurë", "e enjte", "e premte", "e shtunë"
        ], "SHORTDAY":["Die", "Hën", "Mar", "Mër", "Enj", "Pre", "Sht"], "AMPMS":[
            "PD", "MD"
        ], "medium":"yyyy-MM-dd h.mm.ss.a", "short":"yy-MM-dd h.mm.a", "fullDate":"EEEE, dd MMMM y", "longDate":"dd MMMM y", "mediumDate":"yyyy-MM-dd", "shortDate":"yy-MM-dd", "mediumTime":"h.mm.ss.a", "shortTime":"h.mm.a"}, "id":"sq-al"});
    }
]);