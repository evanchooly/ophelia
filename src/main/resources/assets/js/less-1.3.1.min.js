...
(function (e, t) {
    ...
    function g(e, t, n, i) {
        ...
        typeof o.overrideMimeType == "function" && o.overrideMimeType("text/css"), o.open("GET", e,
                ...
                && !r.fileAsync ? o.status === 0 || o.status >= 200 && o.status < 300 ? n(o.responseText) : i(o.status,
                e)
    ...
    typeof environment == "object" && {}.toString.call(environment) === "[object Environment]" ? (typeof e
        ...
        return this.env = t = t || {}, this.optimization = "optimization"in this.env ? this.env.optimization
            ...
            o = u = h = l = 0, s = e.replace(/\r\n/g, "\n"), s = s.replace(/^\uFEFF/, ""), c = function (e) {
                ...
                return u > 0 && (x
                        = new O({index: c, type: "Parse", message: "missing closing `}`", filename: t.filename},
                        t)), e.map(function (e) {
                    return e.join("")
                })
            }([
            ...
            return e = E(this.entities.quoted) || E(this.entities.variable) || E(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/)
                    || "", x(")"), new i.URL(e.value != null || e instanceof i.Variable ? e : new i.Anonymous(e),
                    m.paths)
        }, variable: function () {
            var e, n = o;
            if (s.charAt(o) === "@" && (e = E(/^@@?[\w-]+/))) {
            ...
            return E(this.entities.literal) || E(this.entities.variable) || E(this.entities.url)
                    || E(this.entities.call) || E(this.entities.keyword) || E(this.entities.javascript)
                    || E(this.comment)
        }, end: function () {
            return E(";") || N("}")
        }, alpha: function () {
            ...
            n = E(this.combinator), e = E(/^(?:\d+\.\d+|\d+)%/)
                    || E(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || E("*")
                    || E("&")
            ...
            if (t = E(/^(?:[_A-Za-z0-9-]|\\.)+/) || E(this.entities.quoted)) {
                (r = E(/^[|~*$^]?=/)) && (n
                        = E(this.entities.quoted) || E(/^[\w-]+/)) ? e = [t, r, n.toCSS ? n.toCSS() : n].join("") : e
                        = t;
            }
            if (!E("]")) {
                return;
            ...
            if (e = E(this.addition) || E(this.entities.keyword) || E(this.entities.quoted)) {
                return(r
                        ...
                        new i.Keyword("true"), s, u), x(")"), E(/^and/) ? new i.Condition("and", n, E(this.condition))
                        : n
            }
        }, operand: function () {
    ...
    (function (e) {
        ...
        e.Media = function (t, n) {
            ...
            return this.debugInfo && (this.ruleset.debugInfo = this.debugInfo, r.debugInfo = this.debugInfo), r.features
                    ...
                    = this.ruleset.eval(t), t.frames.shift(), t.mediaBlocks[n]
                    = r, t.mediaPath.pop(), t.mediaPath.length
        ...
        e.Rule = function (t, n, r, i, s) {
            this.name = t, this.value = n instanceof e.Value ? n : new e.Value([n]), this.important = r ? " " + r.trim()
                    : "", this.index = i, this.inline = s || !1, t.charAt(0) === "@" ? this.variable = !0
                    : this.variable
                    = !1
        ...
        e.Ruleset = function (e, t, n) {
            ...
            for (var c = 0; c < this.rules.length; c++) {
                l = this.rules[c], l.rules || l instanceof e.Directive || l
                        ...
                        ? o.push(l.toCSS(n)) : i.push(l.toCSS(n))) : l.toCSS && !l.variable ? i.push(l.toCSS(n))
                        : l.value
                        ...
                        if (n.length == 0) {
                            ...
                            for (o = 0; o < n.length; o++) {
                                c = n[o], h = [], p = [], v
                                        ...
                                        = new e.Selector(m.elements.slice(0)), v = !1) : d
                                        = new e.Selector([]), c.length
                                        > 1
                                        && (p
