angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"NUMBER_FORMATS": {"DECIMAL_SEP": ",", "GROUP_SEP": ".", "PATTERNS": [
            ...
            "AM",
            "PM"
        ], "medium": "d MMM y HH:mm:ss", "short": "dd-MM-yy HH:mm", "fullDate": "EEEE d MMMM y", "longDate": "d MMMM y", "mediumDate": "d MMM y", "shortDate": "dd-MM-yy", "mediumTime": "HH:mm:ss", "shortTime": "HH:mm"}, "id": "nl-nl"});
    }
]);