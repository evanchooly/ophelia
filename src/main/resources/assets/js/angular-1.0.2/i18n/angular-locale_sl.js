angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"DATETIME_FORMATS": {"MONTH": [
            ...
            "nov.",
            "dec."
        ], "DAY": ["nedelja", "ponedeljek", "torek", "sreda", "četrtek", "petek", "sobota"], "SHORTDAY": [
            "ned",
            "pon",
            "tor",
            "sre",
            ...
            "dop.",
            "pop."
        ], "medium": "d. MMM yyyy HH:mm:ss", "short": "d. MM. yy HH:mm", "fullDate": "EEEE, dd. MMMM y", "longDate": "dd. MMMM y", "mediumDate": "d. MMM yyyy", "shortDate": "d. MM. yy", "mediumTime": "HH:mm:ss", "shortTime": "HH:mm"}, "NUMBER_FORMATS": {"DECIMAL_SEP": ",", "GROUP_SEP": ".", "PATTERNS": [
