angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"NUMBER_FORMATS": {"DECIMAL_SEP": ",", "GROUP_SEP": ".", "PATTERNS": [
            ...
            "a.m.",
            "p.m."
        ], "medium": "dd/MM/yyyy H:mm:ss", "short": "dd/MM/yy H:mm", "fullDate": "EEEE d MMMM 'de' y", "longDate": "d MMMM 'de' y", "mediumDate": "dd/MM/yyyy", "shortDate": "dd/MM/yy", "mediumTime": "H:mm:ss", "shortTime": "H:mm"}, "id": "ca-es"});
    }
]);