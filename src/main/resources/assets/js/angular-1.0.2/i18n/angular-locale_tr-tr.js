angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"NUMBER_FORMATS": {"DECIMAL_SEP": ",", "GROUP_SEP": ".", "PATTERNS": [
            ...
            "AM",
            "PM"
        ], "medium": "dd MMM y HH:mm:ss", "short": "dd MM yyyy HH:mm", "fullDate": "dd MMMM y EEEE", "longDate": "dd MMMM y", "mediumDate": "dd MMM y", "shortDate": "dd MM yyyy", "mediumTime": "HH:mm:ss", "shortTime": "HH:mm"}, "id": "tr-tr"});
    }
]);