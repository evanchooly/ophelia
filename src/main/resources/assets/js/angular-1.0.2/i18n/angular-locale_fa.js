angular.module("ngLocale", [], [
    "$provide", function ($provide) {
        ...
        $provide.value("$locale", {"DATETIME_FORMATS": {"MONTH": [
            "ژانویهٔ", "فوریهٔ", "مارس", "آوریل", "می", "جون", "جولای", "آگوست",
        ...
        ], "medium": "MMM d, y H:mm:ss", "short": "M/d/yy H:mm", "fullDate": "EEEE, MMMM d, y", "longDate": "MMMM d, y", "mediumDate": "MMM d, y", "shortDate": "M/d/yy", "mediumTime": "H:mm:ss", "shortTime": "H:mm"}, "NUMBER_FORMATS": {"DECIMAL_SEP": "/", "GROUP_SEP": "،", "PATTERNS": [
