        ...
        if (t1 == t2) {
            if (t1 == 'object') {
                if (isArray(o1)) {
                    ...
                    for (key in o2) {
                        if (!keySet[key] && key.charAt(0) !== '$' && !isFunction(o2[key])) {
                            return false;
                        }
                    }
                    return true;
...
///////////////////////////////////////
        ...
        self.cookies = function (name, value) {
            ...
            if (name) {
                if (value === undefined) {
                    ...
                    if (isString(value)) {
                        cookieLength = (rawDocument.cookie = escape(name) + '=' + escape(value) + ';path='
                                + cookiePath).length + 1;
    ...
    function $CompileProvider($provide) {
        ...
        this.$get = [
            ...
            function ($injector, $interpolate, $exceptionHandler, $http, $templateCache, $parse, $controller,
                ...
                function compileTemplateUrl(directives, beforeTemplateNodeLinkFn, $compileNode, tAttrs, $rootElement,
                        replace, childTranscludeFn) {
                    var linkQueue = [],
                            ...
                            success(function (content) {
                                ...
                                while (linkQueue.length) {
                                    ...
                                    afterTemplateNodeLinkFn(function () {
                                        beforeTemplateNodeLinkFn(afterTemplateChildLinkFn, scope, linkNode,
                                                $rootElement,
                                                controller);
                    ...
                    return function delayedNodeLinkFn(ignoreChildLinkFn, scope, node, rootElement, controller) {
                        if (linkQueue) {
                            ...
                            afterTemplateNodeLinkFn(function () {
                                beforeTemplateNodeLinkFn(afterTemplateChildLinkFn, scope, node, rootElement,
                                        controller);
    ...
    function nodesetLinkingFn(/* angular.Scope */ scope, /* NodeList */ nodeList, /* Element */ rootElement,
        /* function(Function) */ boundTranscludeFn) {
    }

    function directiveLinkingFn(/* nodesetLinkingFn */ nodesetLinkingFn, /* angular.Scope */ scope, /* Node */ node,
        /* Element */ rootElement, /* function(Function) */ boundTranscludeFn) {
    }
...
///////////////////////////////////
    ...
    function $ParseProvider() {
        var cache = {};
        this.$get = [
            '$filter', '$sniffer', function ($filter, $sniffer) {
                return function (exp) {
                    switch (typeof exp) {
                        case 'string':
                                ...
                                then(function () {
                                    if (next) {
                                        ...
                                        forEach(next.resolve || {}, function (value, key) {
                                            keys.push(key);
                                            values.push(isFunction(value) ? $injector.invoke(value)
                                                    : $injector.get(value));
                                        });
    ...
    function $RootScopeProvider() {
        ...
        this.$get = [
            '$injector', '$exceptionHandler', '$parse',
                                            ...
                                            if ((value = watch.get(current)) !== (last = watch.last) && !(watch.eq
                                                ...
                                                if (ttl < 5) {
                                                    ...
                                                    logMsg = (isFunction(watch.exp))
                                                            ...
                                                            : watch.exp;
                                                    logMsg += '; newVal: ' + toJson(value) + '; oldVal: '
                                                            + toJson(last);
    ...
    function dateFilter($locale) {
        ...
        function jsonStringToDate(string) {
            ...
            if (match = string.match(R_ISO8601_STR)) {
                ...
                date.setUTCHours(int(match[4] || 0) - tzHour, int(match[5] || 0) - tzMin, int(match[6] || 0),
                        int(match[7] || 0));
                return date;
            }
            return string;
