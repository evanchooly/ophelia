...
angular.module('ui.directives').directive('uiCurrency', [
    'ui.config', 'currencyFilter' , function (uiConfig, currencyFilter) {
        var options = {
            pos:'ui-currency-pos',
            neg:'ui-currency-neg',
                    ...
                    if (controller) {
                        ...
                        controller.$render = function () {
                            ...
                            if (angular.isDefined(date) && date !== null && !angular.isDate(date)) {
                                throw new Error('ng-Model value must be a Date object - currently it is a '
                                    + typeof date + ' - use ui-date-format to convert it from a string');
                            }
        ...
        return function (mode, scope, elm, attrs) {
            ...
            elm.bind(mode, function (event) {
                ...
                angular.forEach(combinations, function (combination) {
                    var mainKeyPressed = (combination.keys[keysByCode[event.keyCode]]
                        || combination.keys[event.keyCode.toString()]) || false;
...
angular.module('ui.directives').directive('uiSelect2', [
    'ui.config', '$http', function (uiConfig, $http) {
        var options = {};
        if (uiConfig.select2) {
...
angular.module('ui.filters').filter('inflector', function () {
    ...
    var inflectors = {
        ...
        variable:function (value) {
            value = value.substr(0, 1).toLowerCase()
