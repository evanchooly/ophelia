...
(function (e, t) {
    ...
    function h() {
        ...
        for (var t = 0; t < e.length; t++) {
            e[t].type.match(l)
            && (new r.Parser({filename:document.location.href.replace(/#.*$/,
    ...
    function p(e, t) {
        for (var n = 0; n < r.sheets.length; n++) {
            d(r.sheets[n], e, t, r.sheets.length - (n + 1))
        }
    }

    function d(t, n, i, s) {
        var o = t.contents || {}, a = e.location.href.replace(/[#?].*$/, ""), f = t.href.replace(/\?.*$/, ""), l = u
            && u.getItem(f), c = u && u.getItem(f + ":timestamp"), h = {css:l, timestamp:c};
        /^[a-z-]+:/.test(f) || (f.charAt(0) == "/" ? f = e.location.protocol + "//" + e.location.host + f : f
            = a.slice(0, a.lastIndexOf("/") + 1) + f), g(t.href, t.type, function (e, u) {
            if (!i && h && u && (new Date(u)).valueOf() === (new Date(h.timestamp)).valueOf()) {
                m(h.css, t), n(null, null,
                    e, t, {local:!0, remaining:s});
            } else {
                try {
                    o[f] = e, (new r.Parser({optimization:r.optimization, paths:[
                        f.replace(/[\w\.-]+$/, "")
                    ], mime:t.type, filename:f, contents:o, dumpLineNumbers:r.dumpLineNumbers})).parse(e,
                        function (r, i) {
                            if (r) {
                                return E(r, f);
                            }
                            try {
                                n(r, i, e, t,
                                    {local:!1, lastModified:u, remaining:s}), b(document.getElementById("less-error-message:"
                                    + v(f)))
                            } catch (r) {
                                E(r, f)
                            }
    ...
    function v(e) {
        return e.replace(/^[a-z]+:\/\/?[^\/]+/, "").replace(/^\//, "").replace(/\?.*$/, "").replace(/\.[^\.\/]+$/,
    ...
    function m(e, t, n) {
        ...
        if (r.styleSheet) {
            ...
            (function (e) {
                r.childNodes.length > 0 ? r.firstChild.nodeValue !== e.nodeValue && r.replaceChild(e, r.firstChild)
                    : r.appendChild(e)
    ...
    function g(e, t, n, i) {
        function a(t, n, r) {
            t.status >= 200 && t.status < 300 ? n(t.responseText, t.getResponseHeader("Last-Modified")) : typeof r
                == "function" && r(t.status, e)
        }

        var o = y(), u = s ? r.fileAsync : r.async;
        typeof o.overrideMimeType == "function" && o.overrideMimeType("text/css"), o.open("GET", e,
            u), o.setRequestHeader("Accept", t || "text/x-less, text/css; q=0.9, */*; q=0.5"), o.send(null), s
            && !r.fileAsync ? o.status === 0 || o.status >= 200 && o.status < 300 ? n(o.responseText) : i(o.status, e)
    ...
    function E(e, t) {
        var n = "less-error-message:"
            + v(t), i = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>', s = document.createElement("div"), o, u, a =
            [], f = e.filename || t, l = f.match(/([^\/]+)$/)[1];
        s.id = n, s.className = "less-error-message", u = "<h3>" + (e.message || "There is an error in your .less file")
            + "</h3>" + '<p>in <a href="' + f + '">' + l + "</a> ";
        var c = function (e, t, n) {
            e.extract[t] && a.push(i.replace(/\{line\}/, parseInt(e.line) + (t - 1)).replace(/\{class\}/,
                n).replace(/\{content\}/, e.extract[t]))
        };
        e.stack ? u += "<br/>" + e.stack.split("\n").slice(1).join("<br/>") : e.extract && (c(e, 0, ""), c(e, 1,
            "line"), c(e, 2, ""), u += "on line " + e.line + ", column " + (e.column + 1) + ":</p>" + "<ul>"
            + a.join("") + "</ul>"), s.innerHTML = u, m([
            ...
            "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a",
            "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;",
            "border-bottom: 1px dashed red;", "}"
        ].join("\n"), {title:"error-message"}), s.style.cssText = [
            "font-family: Arial, sans-serif",
            "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px",
            "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"
        ].join(";"), r.env == "development" && (o = setInterval(function () {
            document.body && (document.getElementById(n) ? document.body.replaceChild(s, document.getElementById(n))
                : document.body.insertBefore(s, document.body.firstChild), clearInterval(o))
        }, 10))
    }
    ...
    typeof environment == "object" && {}.toString.call(environment) === "[object Environment]" ? (typeof e
        == "undefined" ? r = {} : r = e.less = {}, i = r.tree = {}, r.mode = "rhino") : typeof e == "undefined" ? (r
        = exports, i = n("./tree"), r.mode = "node") : (typeof e.less == "undefined" && (e.less = {}), r = e.less, i
        = e.less.tree = {}, r.mode = "browser"), r.Parser = function (t) {
        function g() {
            a = c[u], f = o, h = o
        }
        ...
        function S(e) {
            ...
            return c[u] = c[u].slice(e + (o - i)), h = o, c[u].length === 0 && u < c.length - 1 && u++, t !== o || n
                !== u
        }
        ...
        function O(e, t) {
            ...
            this.type = e.type || "Syntax", this.message = e.message, this.filename = e.filename
                || t.filename, this.index = e.index, this.line = typeof i == "number" ? i + 1 : null, this.callLine
                = e.call && k(e.call, n).line + 1, this.callExtract = o[k(e.call, n).line], this.stack
                = e.stack, this.column = s, this.extract = [o[i - 1], o[i], o[i + 1]]
        }

        var s, o, u, a, f, l, c, h, p, d = this, t = t || {};
        t.contents || (t.contents = {});
        var v = function () {
        }, m = this.imports = {paths:t && t.paths || [], queue:[], files:{}, contents:t.contents, mime:t
            && t.mime, error:null, push:function (e, n) {
            var i = this;
        ...
        return this.env = t = t || {}, this.optimization = "optimization"in this.env ? this.env.optimization
            : 1, this.env.filename = this.env.filename || null, p = {imports:m, parse:function (e, a) {
            var f, d, m, g, y, b, w = [], S, x = null;
            o = u = h = l = 0, s = e.replace(/\r\n/g, "\n"), s = s.replace(/^\uFEFF/, ""), c = function (e) {
                var n = 0, r = /(?:@\{[\w-]+\}|[^"'`\{\}\/\(\)\\])+/g, i = /\/\*(?:[^*]|\*+[^\/*])*\*+\/|\/\/.*/g, o = /"((?:[^"\\\r\n]|\\.)*)"|'((?:[^'\\\r\n]|\\.)*)'|`((?:[^`]|\\.)*)`/g, u = 0, a, f = e[0], l;
                for (var c = 0, h, p; c < s.length; c++) {
                    r.lastIndex = c, (a = r.exec(s)) && a.index === c && (c += a[0].length, f.push(a[0])), h
                        = s.charAt(c), i.lastIndex = o.lastIndex = c, (a = o.exec(s)) && a.index === c && (c
                        += a[0].length, f.push(a[0]), h = s.charAt(c)), !l && h === "/" && (p = s.charAt(c + 1), (p
                        === "/" || p === "*") && (a = i.exec(s)) && a.index === c && (c += a[0].length, f.push(a[0]), h
                        = s.charAt(c)));
                    switch (h) {
                        case"{":
                            if (!l) {
                ...
                return u > 0 && (x = new O({index:c, type:"Parse", message:"missing closing `}`", filename:t.filename},
                    t)), e.map(function (e) {
                    return e.join("")
                })
            }([
            ...
            f.toCSS = function (e) {
                ...
                return function (s, o) {
                    ...
                    s = s || {}, typeof o == "object" && !Array.isArray(o) && (o = Object.keys(o).map(function (e) {
                        var t = o[e];
                        return t instanceof i.Value || (t instanceof i.Expression || (t = new i.Expression([t])), t
                            = new i.Value([t])), new i.Rule("@" + e, t, !1, 0)
                    }), u = [new i.Ruleset(null, o)]);
                    try {
                        var f = e.call(this, {frames:u}).toCSS([],
                            {compress:s.compress || !1, dumpLineNumbers:t.dumpLineNumbers})
                    } catch (l) {
                        throw new O(l, t)
                    }
                    ...
                    return s.yuicompress && r.mode === "node" ? n("./cssmin").compressor.cssmin(f) : s.compress
                        ? f.replace(/(\s)+/g, "$1") : f
                }
            }(f.eval);
            if (o < s.length - 1) {
                ...
                x = {type:"Parse", message:"Syntax Error on line "
                    + y, index:o, filename:t.filename, line:y, column:C, extract:[b[y - 2], b[y - 1], b[y]]}
            }
            ...
            var e, t = [];
            while ((e = E(this.mixin.definition) || E(this.rule) || E(this.ruleset) || E(this.mixin.call)
                || E(this.comment) || E(this.directive)) || E(/^[\s\n]+/)) {
                e && t.push(e);
            }
            return t
        }, comment:function () {
            ...
            if (e = E(/^[_A-Za-z-][_A-Za-z0-9-]*/)) {
                return i.colors.hasOwnProperty(e) ? new i.Color(i.colors[e].slice(1))
                    : new i.Keyword(e)
            }
        }, call:function () {
            var e, n, r, s, a = o;
            ...
            return E(this.entities.ratio) || E(this.entities.dimension) || E(this.entities.color)
            ...
            return e = E(this.entities.quoted) || E(this.entities.variable) || E(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/)
                || "", x(")"), new i.URL(e.value != null || e instanceof i.Variable ? e : new i.Anonymous(e), m.paths)
        }, variable:function () {
            var e, n = o;
            if (s.charAt(o) === "@" && (e = E(/^@@?[\w-]+/))) {
            ...
            if (e.length > 0 && (E(";") || N("}"))) {
                return new i.mixin.Call(e, u, f, t.filename, p);
            }
            y()
        }, definition:function () {
            ...
            return E(this.entities.literal) || E(this.entities.variable) || E(this.entities.url)
                || E(this.entities.call) || E(this.entities.keyword) || E(this.entities.javascript) || E(this.comment)
        }, end:function () {
            return E(";") || N("}")
        }, alpha:function () {
            var e;
            ...
            var e, t, n, r;
            n = E(this.combinator), e = E(/^(?:\d+\.\d+|\d+)%/)
                || E(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || E("*") || E("&")
                || E(this.attribute) || E(/^\([^)@]+\)/) || E(/^[\.#](?=@)/) || E(this.entities.variableCurly), e
                || E("(") && (r = E(this.entities.variableCurly) || E(this.entities.variable)) && E(")") && (e
                = new i.Paren(r));
            if (e) {
            ...
            var e, t, n = [], r, u;
            if (E("(")) {
                return e = E(this.entity), x(")"), new i.Selector([new i.Element("", e, o)]);
            }
            ...
            if (t = E(/^(?:[_A-Za-z0-9-]|\\.)+/) || E(this.entities.quoted)) {
                (r = E(/^[|~*$^]?=/)) && (n
                    = E(this.entities.quoted) || E(/^[\w-]+/)) ? e = [t, r, n.toCSS ? n.toCSS() : n].join("") : e = t;
            }
            if (!E("]")) {
                return;
            }
            ...
            if (e = E(this.variable) || E(this.property)) {
                e.charAt(0) != "@" && (a = /^([^@+\/'"*`(;{}-]*);/.exec(c[u])) ? (o += a[0].length - 1, t
                    = new i.Anonymous(a[1])) : e === "font" ? t = E(this.font) : t = E(this.value), r
                    = E(this.important);
                if (t && E(this.end)) {
            ...
            if (r && (e = E(this.entities.quoted) || E(this.entities.url))) {
                ...
                if (E(";")) {
                    return new i.Import(e, m, t, r[1] === "once", n)
                }
            }
            y()
            ...
            if (t = E(this["import"]) || E(this.media)) {
                return t;
            }
            g(), e = E(/^@[a-z-]+/), f = e, e.charAt(1) == "-" && e.indexOf("-", 2) > 0 && (f = "@"
            ...
            if (l) {
                if (n = E(this.block)) {
                    return new i.Directive(e, n)
                }
            } else if ((t = E(this.entity)) && E(";")) {
                return new i.Directive(e, t);
            }
            y()
        }, font:function () {
            var e = [], t = [], n, r, s, o;
            ...
            if (e = E(this.addition) || E(this.entities.keyword) || E(this.entities.quoted)) {
                return(r
                    = E(/^(?:>=|=<|[<=>])/)) ? (t = E(this.addition) || E(this.entities.keyword)
                    || E(this.entities.quoted))
                    ? n = new i.Condition(r, e, t, s, u) : T("expected expression") : n = new i.Condition("=", e,
                    new i.Keyword("true"), s, u), x(")"), E(/^and/) ? new i.Condition("and", n, E(this.condition)) : n
            }
        }, operand:function () {
            var e, t = s.charAt(o + 1);
            s.charAt(o) === "-" && (t === "@" || t === "(") && (e = E("-"));
            var n = E(this.sub) || E(this.entities.dimension) || E(this.entities.color) || E(this.entities.variable)
    ...
    if (r.mode === "browser" || r.mode === "rhino") {
        r.Parser.importer = function (e, t, n, r) {
            !/^([a-z-]+:)?\//.test(e) && t.length > 0 && (e = t[0]
                + e), d({href:e, title:e, type:r.mime, contents:r.contents}, function (i) {
    ...
    (function (e) {
        ...
        e.functions = {rgb:function (e, t, n) {
            ...
            function u(e) {
                return e = e < 0 ? e + 1 : e > 1 ? e - 1 : e, e * 6 < 1 ? o + (s - o) * e * 6 : e * 2 < 1 ? s : e * 3
                    < 2 ? o + (s - o) * (2 / 3 - e) * 6 : o
            }
            ...
            return new e.Dimension(Math.round((.2126 * (t.rgb[0] / 255) + .7152 * (t.rgb[1] / 255) + .0722 * (t.rgb[2]
                / 255)) * t.alpha * 100), "%")
            ...
            var i = r.value / 100, s = i * 2 - 1, o = t.toHSL().a - n.toHSL().a, u = ((s * o == -1 ? s : (s + o) / (1
                + s * o)) + 1) / 2, a = 1 - u, f = [
                t.rgb[0] * u + n.rgb[0] * a, t.rgb[1] * u + n.rgb[1] * a,
                t.rgb[2] * u + n.rgb[2] * a
            ...
            return typeof n == "undefined" && (n = this.rgba(255, 255, 255, 1)), typeof t == "undefined" && (t
                = this.rgba(0, 0, 0, 1)), typeof r == "undefined" ? r = .43 : r = r.value, (.2126 * (e.rgb[0] / 255)
                + .7152 * (e.rgb[1] / 255) + .0722 * (e.rgb[2] / 255)) * e.alpha < r ? n : t
        }, e:function (t) {
            return new e.Anonymous(t instanceof e.JavaScript ? t.evaluated : t)
        }, escape:function (t) {
            return new e.Anonymous(encodeURI(t.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g,
            ...
            if (t instanceof e.Dimension) {
                return new e.Dimension(n(t).toFixed(i), t.unit);
            }
            if (typeof t == "number") {
                return t.toFixed(i);
            }
            ...
            if (r instanceof e.Dimension) {
                return new e.Dimension(Math[t](n(r)), r.unit);
            }
            if (typeof r == "number") {
                return Math[t](r);
            }
            ...
            var n = 255 - (255 - e.rgb[0]) * (255 - t.rgb[0]) / 255, r = 255 - (255 - e.rgb[1]) * (255 - t.rgb[1])
                / 255, i = 255 - (255 - e.rgb[2]) * (255 - t.rgb[2]) / 255;
            return this.rgb(n, r, i)
        }, overlay:function (e, t) {
            var n = e.rgb[0] < 128 ? 2 * e.rgb[0] * t.rgb[0] / 255 : 255 - 2 * (255 - e.rgb[0]) * (255 - t.rgb[0])
                / 255, r = e.rgb[1] < 128 ? 2 * e.rgb[1] * t.rgb[1] / 255 : 255 - 2 * (255 - e.rgb[1]) * (255
                - t.rgb[1]) / 255, i = e.rgb[2] < 128 ? 2 * e.rgb[2] * t.rgb[2] / 255 : 255 - 2 * (255 - e.rgb[2])
                * (255 - t.rgb[2]) / 255;
            return this.rgb(n, r, i)
        }, softlight:function (e, t) {
            var n = t.rgb[0] * e.rgb[0] / 255, r = n + e.rgb[0] * (255 - (255 - e.rgb[0]) * (255 - t.rgb[0]) / 255 - n)
                / 255;
            ...
            var n = t.rgb[0] < 128 ? 2 * t.rgb[0] * e.rgb[0] / 255 : 255 - 2 * (255 - t.rgb[0]) * (255 - e.rgb[0])
                / 255, r = t.rgb[1] < 128 ? 2 * t.rgb[1] * e.rgb[1] / 255 : 255 - 2 * (255 - t.rgb[1]) * (255
                - e.rgb[1]) / 255, i = t.rgb[2] < 128 ? 2 * t.rgb[2] * e.rgb[2] / 255 : 255 - 2 * (255 - t.rgb[2])
                * (255 - e.rgb[2]) / 255;
            return this.rgb(n, r, i)
            ...
            var n = e.rgb[0] + t.rgb[0] * (255 - e.rgb[0] - e.rgb[0]) / 255, r = e.rgb[1] + t.rgb[1] * (255 - e.rgb[1]
                - e.rgb[1]) / 255, i = e.rgb[2] + t.rgb[2] * (255 - e.rgb[2] - e.rgb[2]) / 255;
            return this.rgb(n, r, i)
        ...
        e.Call = function (e, t, n, r) {
            ...
            try {
                ...
                throw{type:r.type || "Runtime", message:"error evaluating function `" + this.name + "`" + (r.message
                    ? ": " + r.message : ""), index:this.index, filename:this.filename}
            }
        }, toCSS:function (e) {
        ...
        e.Color = function (e, t) {
            ...
            var e = this.rgb[0] / 255, t = this.rgb[1] / 255, n = this.rgb[2] / 255, r = this.alpha, i = Math.max(e, t,
                n), s = Math.min(e, t,
                n), o, u, a = (i + s) / 2, f = i - s;
            if (i === s) {
                o = u = 0;
            ...
            return e.rgb ? e.rgb[0] === this.rgb[0] && e.rgb[1] === this.rgb[1] && e.rgb[2] === this.rgb[2] && e.alpha
                === this.alpha ? 0 : -1 : -1
        }}
    }(n("../tree")), function (e) {
        ...
        e.Directive = function (t, n) {
            this.name = t, Array.isArray(n) ? (this.ruleset = new e.Ruleset([], n), this.ruleset.allowImports = !0)
                : this.value = n
        ...
        e.Element = function (t, n, r) {
            this.combinator = t instanceof e.Combinator ? t : new e.Combinator(t), typeof n == "string" ? this.value
                = n.trim() : n ? this.value = n : this.value = "", this.index = r
        ...
        e.Import = function (t, n, r, i, s) {
            var o = this;
            this.once = i, this.index = s, this._path = t, this.features = r && new e.Value(r), t instanceof e.Quoted
                ? this.path = /\.(le?|c)ss(\?.*)?$/.test(t.value) ? t.value : t.value + ".less" : this.path
                = t.value.value || t.value, this.css = /css(\?.*)?$/.test(this.path), this.css || n.push(this.path,
                function (t, n, r) {
            ...
            for (var i = 0; i < n.rules.length; i++) {
                n.rules[i]instanceof e.Import
                && Array.prototype.splice.apply(n.rules, [i, 1].concat(n.rules[i].eval(t)));
            }
        ...
        e.JavaScript = function (e, t, n) {
            ...
            for (var u in t.frames[0].variables()) {
                i[u.slice(1)]
                    = {value:t.frames[0].variables()[u].value, toJS:function () {
        ...
        e.Media = function (t, n) {
            ...
            var r = new e.Media([], []);
            return this.debugInfo && (this.ruleset.debugInfo = this.debugInfo, r.debugInfo = this.debugInfo), r.features
                = this.features.eval(t), t.frames.unshift(this.ruleset), r.ruleset
                = this.ruleset.eval(t), t.frames.shift(), t.mediaBlocks[n] = r, t.mediaPath.pop(), t.mediaPath.length
                === 0 ? r.evalTop(t) : r.evalNested(t)
        }, variable:function (t) {
            return e.Ruleset.prototype.variable.call(this.ruleset, t)
        }, find:function () {
            return e.Ruleset.prototype.find.apply(this.ruleset, arguments)
            ...
            for (n = 0; n < i.length; n++) {
                r = i[n].features instanceof e.Value ? i[n].features.value
        ...
        e.mixin = {}, e.mixin.Call = function (t, n, r, i, s) {
            ...
            for (var s = 0; s < e.frames.length; s++) {
                if ((t = e.frames[s].find(this.selector)).length > 0) {
                    ...
                    for (var o = 0; o < t.length; o++) {
                        if (t[o].match(n, e)) {
                            try {
                                Array.prototype.push.apply(r, t[o].eval(e, this.arguments, this.important).rules), i
                                    = !0
                            } catch (u) {
                    ...
                    throw{type:"Runtime", message:"No matching definition was found for `"
            ...
            throw{type:"Name", message:this.selector.toCSS().trim()
                + " is undefined", index:this.index, filename:this.filename}
        }}, e.mixin.Definition = function (t, n, r, i, s) {
            this.name = t, this.selectors = [new e.Selector([new e.Element(null, t)])], this.params = n, this.condition
                = i, this.variadic = s, this.arity = n.length, this.rules = r, this._lookups = {}, this.required
                    ...
                    if (this.params[o].variadic && n) {
                        ...
                        if (!(u = s && s.value
                            ...
                            throw{type:"Runtime", message:"wrong number of arguments for "
                                + this.name + " (" + n.length + " for " + this.arity + ")"};
                        }
            ...
            for (var f = 0; f < Math.max(this.params.length, n && n.length); f++) {
                o.push(n[f] && n[f].value
                    || this.params[f].value);
            }
            return i.rules.unshift(new e.Rule("@arguments", (new e.Expression(o)).eval(t))), u = r
                ? this.rules.map(function (t) {
            ...
            if (this.condition && !this.condition.eval({frames:[this.evalParams(t, e)].concat(t.frames)})) {
                return!1;
            }
            r = Math.min(n, this.arity);
            for (var s = 0; s < r; s++) {
                if (!this.params[s].name && e[s].value.eval(t).toCSS()
        ...
        e.Rule = function (t, n, r, i, s) {
            this.name = t, this.value = n instanceof e.Value ? n : new e.Value([n]), this.important = r ? " " + r.trim()
                : "", this.index = i, this.inline = s || !1, t.charAt(0) === "@" ? this.variable = !0 : this.variable
                = !1
        ...
        e.Ruleset = function (e, t, n) {
            ...
            r.root = this.root, r.allowImports = this.allowImports, this.debugInfo && (r.debugInfo
                = this.debugInfo), t.frames.unshift(r);
            if (r.root || r.allowImports || !r.strictImports) {
                for (var s = 0; s < r.rules.length; s++) {
                    r.rules[s]instanceof e.Import ? i = i.concat(r.rules[s].eval(t))
                        : i.push(r.rules[s]);
                }
                r.rules = i, i = []
            }
            for (var s = 0; s < r.rules.length; s++) {
                r.rules[s]instanceof e.mixin.Definition && (r.rules[s].frames
                    = t.frames.slice(0));
            }
            var o = t.mediaBlocks && t.mediaBlocks.length || 0;
            for (var s = 0; s < r.rules.length; s++) {
                r.rules[s]instanceof e.mixin.Call ? i = i.concat(r.rules[s].eval(t))
                    : i.push(r.rules[s]);
            }
            r.rules = i;
            for (var s = 0, u; s < r.rules.length; s++) {
                u = r.rules[s], u instanceof e.mixin.Definition || (r.rules[s]
                    = u.eval ? u.eval(t) : u);
            }
            t.frames.shift();
            if (t.mediaBlocks) {
            ...
            for (var c = 0; c < this.rules.length; c++) {
                l = this.rules[c], l.rules || l instanceof e.Directive || l
                    instanceof e.Media ? o.push(l.toCSS(u, n)) : l instanceof e.Comment ? l.silent || (this.root
                    ? o.push(l.toCSS(n)) : i.push(l.toCSS(n))) : l.toCSS && !l.variable ? i.push(l.toCSS(n)) : l.value
                    && !l.variable && i.push(l.value.toString());
            }
            o = o.join("");
            if (this.root) {
            ...
            for (i = 0; i < r.elements.length; i++) {
                ...
                if (f.value !== "&") {
                    ...
                    for (s = 0; s < a.length; s++) {
                        l = a[s];
                        if (n.length == 0) {
                            l.length > 0 && (l[0].elements
                                = l[0].elements.slice(0), l[0].elements.push(new e.Element(f.combinator, "",
                                0))), y.push(l);
                        } else {
                            for (o = 0; o < n.length; o++) {
                                c = n[o], h = [], p = [], v
                                    = !0, l.length > 0 ? (h = l.slice(0), m = h.pop(), d
                                    = new e.Selector(m.elements.slice(0)), v = !1) : d = new e.Selector([]), c.length
                                    > 1
                                    && (p
                                    = p.concat(c.slice(1))), c.length > 0 && (v
                                    = !1, d.elements.push(new e.Element(f.combinator, c[0].elements[0].value,
                                    0)), d.elements
                                    = d.elements.concat(c[0].elements.slice(1))), v || h.push(d), h
                                    = h.concat(p), y.push(h)
                            }
                        }
                    }
            ...
            for (r = 0; r < n.length; r++) {
                i = n[r], i.length > 0 ? i[i.length - 1] = new e.Selector(i[i.length
                    - 1].elements.concat(t)) : i.push(new e.Selector(t))
            }
        }}
    }(n("../tree")), function (e) {
        e.Selector = function (e) {
            ...
            for (var i = 0; i < r; i++) {
                if (this.elements[i].value !== e.elements[i].value) {
                    return!1;
                }
            }
            return!0
            ...
            return this._css ? this._css : (this.elements[0].combinator.value === "" ? this._css = " " : this._css
        ...
        t.URL = function (e, t) {
            ...
            return typeof e != "undefined" && typeof r.value == "string" && !/^(?:[a-z-]+:|\/)/.test(r.value)
                && this.paths.length > 0 && (r.value = this.paths[0] + (r.value.charAt(0) === "/" ? r.value.slice(1)
                : r.value)), new t.URL(r, this.paths)
        }}
    }(n("../tree")), function (e) {
        e.Value = function (e) {
        ...
        e.debugInfo = function (t, n) {
            ...
            return'@media -sass-debug-info{filename{font-family:"' + e.debugInfo.fileName + '";}line{font-family:"'
    ...
    r.env = r.env || (location.hostname == "127.0.0.1" || location.hostname == "0.0.0.0" || location.hostname
        == "localhost" || location.port.length > 0 || s ? "development" : "production"), r.async = r.async
        || !1, r.fileAsync = r.fileAsync || !1, r.poll = r.poll || (s ? 1e3 : 1500), r.watch = function () {
    ...
    for (var c = 0; c < f.length; c++) {
        (f[c].rel === "stylesheet/less" || f[c].rel.match(/stylesheet/)
            && f[c].type.match(l)) && r.sheets.push(f[c]);
    }
    r.refresh = function (e) {
        var t, n;
        t = n = new Date, p(function (e, r, i, s, o) {
            o.local ? w("loading " + s.href + " from cache.") : (w("parsed " + s.href + " successfully."), m(r.toCSS(),
                s, o.lastModified)), w("css for " + s.href + " generated in " + (new Date - n) + "ms"), o.remaining
                === 0 && w("css generated in " + (new Date - t) + "ms"), n = new Date
        }, e), h()
    }, r.refreshStyles = h, r.refresh(r.env === "development"), typeof define == "function" && define.amd
