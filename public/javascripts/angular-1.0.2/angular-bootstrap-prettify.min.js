...
(function (q, k, I) {
    ...
    var t = {}, w = {value:{}}, L = {"angular.js":"http://code.angularjs.org/angular-" + k.version.full
        + ".min.js", "angular-resource.js":"http://code.angularjs.org/angular-resource-" + k.version.full
        + ".min.js", "angular-sanitize.js":"http://code.angularjs.org/angular-sanitize-" + k.version.full +
        ...
        return{terminal:!0, link:function (x, a, r) {
            ...
            D(a,
                '<form class="jsfiddle" method="post" action="http://jsfiddle.net/api/post/library/pure/" target="_blank">'
                    + d("title", "AngularJS Example: ") + d("css",
                    '</style> <\!-- Ugly Hack due to jsFiddle issue: http://goo.gl/BUfGZ --\> \n<link rel="stylesheet" href="http://twitter.github.com/bootstrap/assets/css/bootstrap.css">\n'
                        + b.angular + (r.resource ? b.resource : "") + "<style>\n" + H.css) + d("html", H.html)
                    + d("js", H.js)
                    + '<button class="btn btn-primary"><i class="icon-white icon-pencil"></i> Edit Me</button></form>')
        }}
    };
    t.code = function () {
    ...
    t.ngSetText = [
        "getEmbeddedTemplate", function (c) {
    ...
    t.ngEmbedApp = [
        "$templateCache", "$browser", "$rootScope", "$location", function (c, e, b, x) {
            return{terminal:!0, link:function (a, r, d) {
                ...
                a.push([
                    "$provide", function (a) {
                        ...
                        a.decorator("$timeout", [
                            "$rootScope", "$delegate", function (a, b) {
    ...
    (function () {
        function c(a) {
            function b(i) {
                ...
                var l = i.charAt(1);
                return(a = k[l]) ? a : "0" <= l && l <= "7" ? parseInt(i.substring(1), 8) : l === "u" || l === "x"
                    ? parseInt(i.substring(2), 16) : i.charCodeAt(1)
            }
            ...
            function M(i) {
                var a = i.substring(1, i.length
                    - 1).match(/\\u[0-9A-Fa-f]{4}|\\x[0-9A-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\s\S]|-|[^-\\]/g), i =
                    [], l = a[0] === "^", f = ["["];
                l && f.push("^");
                for (var l = l ? 1 : 0, g = a.length; l < g; ++l) {
                    ...
                    if (/\\[bdsw]/i.test(j)) {
                        ...
                        h < 65 || j > 122 || (h < 65 || j > 90 || i.push([
                            Math.max(65, j) | 32, Math.min(h, 90) |
                                32
                        ]), h < 97 || j > 122 || i.push([Math.max(97, j) & -33, Math.min(h, 122) & -33]))
                    }
                }
                i.sort(function (i, a) {
                ...
                for (l = 0; l < a.length; ++l) {
                    j = a[l], f.push(A(j[0])), j[1] > j[0] && (j[1] + 1 > j[0]
                        && f.push("-"), f.push(A(j[1])));
                }
                f.push("]");
                return f.join("")
            ...
            function c(i) {
                for (var a = i.source.match(RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)",
                    ...
                    var h = a[g];
                    h === "(" ? ++j : "\\" === h.charAt(0) && (h = +h.substring(1)) && (h <= j ? b[h] = -1 : a[g]
                        = A(h))
                }
                ...
                for (j = g = 0; g < f; ++g) {
                    h = a[g], h === "(" ? (++j, b[j] || (a[g] = "(?:")) : "\\" === h.charAt(0)
                        && (h = +h.substring(1)) && h <= j && (a[g] = "\\" + b[h]);
                }
                for (g = 0; g < f; ++g) {
                    "^" === a[g] && "^" !== a[g + 1] && (a[g] = "");
                }
                if (i.ignoreCase && e) {
                    for (g = 0; g < f; ++g) {
                        h = a[g], i = h.charAt(0), h.length >= 2 && i === "["
                            ? a[g] = M(h) : i !== "\\" && (a[g] = h.replace(/[a-zA-Z]/g, function (a) {
                            a = a.charCodeAt(0);
                ...
                switch (a.nodeType) {
                    ...
                    case 4:
                        f = a.nodeValue, f.length && (f = b ? f.replace(/\r\n?/g, "\n") : f.replace(/[ \t\r\n]+/g,
                            " "), c[m] = f, e[m << 1] = d, d += f.length, e[m++ << 1 | 1] = a)
                }
            }
        ...
        function k(a, d) {
            ...
            var r = d.length, N = function (a) {
                for (var c = a.basePos, B = [c, "pln"], f = 0, k = a.sourceCode.match(e) || [
                ], v = {}, o = 0, i = k.length; o < i; ++o) {
        ...
        function a(a) {
            ...
            b.push(["pln", /^\s+/, null, " \r\n\t\u00a0"]);
            c.push(["lit", /^@[a-z_$][a-z_$@0-9]*/i, null],
                ["typ", /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/, null], ["pln", /^[a-z_$][a-z_$@0-9]*/i, null], [
                    "lit", /^(?:0x[a-f0-9]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+\-]?\d+)?)[a-z]*/i, null,
                    "0123456789"
                ], ["pln", /^\\[\s\S]?/, null], ["pun", /^.[^\s\w\.$@\'\"\`\/\#\\]*/, null]);
            return k(b, c)
        }
        ...
        function r(a, b, c) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        if ("br" === a.nodeName) {
                            ...
                            for (a
                                = a.firstChild; a; a = a.nextSibling) {
                                d(a);
                            }
                        }
                        break;
                    ...
                    case 4:
                        if (c) {
                            ...
                            if (f) {
                                ...
                                && a.parentNode.insertBefore(m.createTextNode(b), a.nextSibling);
                                e(a);
            ...
            for (var k = /(?:^|\s)nocode(?:\s|$)/, r = /\r\n?|\n/, m = a.ownerDocument, p = m.createElement("li");
                a.firstChild;) {
            ...
            for (var b = Math.max(0, b - 1 | 0) || 0, n = 0, o = f.length; n < o; ++n) {
                p = f[n], p.className = "L" + (n
                    + b) % 10, p.firstChild || p.appendChild(m.createTextNode("\u00a0")), v.appendChild(p);
            }
            a.appendChild(v)
        }
        ...
        function D(a) {
            ...
            try {
                ...
                a.basePos = 0;
                t(b, d)(a);
                var k = /\bMSIE\s(\d+)/.exec(navigator.userAgent), k = k && +k[1]
                ...
                try {
                    for (; d < p;) {
                        ...
                        if (C.nodeType !== 1 && (K = r.substring(c, s))) {
                            ...
                            z.replaceChild(w, C);
                            w.appendChild(C);
                            c < h && (m[d + 1] = C = x.createTextNode(r.substring(s, h)), z.insertBefore(C,
                                w.nextSibling))
                        }
                        c = s;
                        c >= h && (d += 2);
        ...
        var F = q, z = ["break,continue,do,else,for,if,return,while"],
            ...
            P = [
                ...
                z, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"
            ...
            L = /\S/, S = a({keywords:[
                ...
                "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END"
                    + P, Q, z
            ], hashComments:!0, cStyleComments:!0, multiLineStrings:!0, regexLiterals:!0}), J = {};
        d(S, ["default-code"]);
        d(k([], [
            ["pln", /^[^<?]+/],
            ["dec", /^<!\w[^>]*(?:>|$)/],
        ...
        d(a({keywords:"caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END", hashComments:!0, multiLineStrings:!0, regexLiterals:!0}),
            [
                "perl",
                "pl", "pm"
            ]);
        ...
        d(a({keywords:"all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,throw,true,try,unless,until,when,while,yes", hashComments:3, cStyleComments:!0, multilineStrings:!0, tripleQuotedStrings:!0, regexLiterals:!0}),
            ["coffee"]);
        d(k([], [
            ["str", /^[\s\S]+/]
        ]), ["regex"]);
        var T = F.PR = {createSimpleLexer:k,
            registerLangHandler:d, sourceDecorator:a, PR_ATTRIB_NAME:"atn", PR_ATTRIB_VALUE:"atv", PR_COMMENT:"com", PR_DECLARATION:"dec", PR_KEYWORD:"kwd", PR_LITERAL:"lit", PR_NOCODE:"nocode", PR_PLAIN:"pln", PR_PUNCTUATION:"pun", PR_SOURCE:"src", PR_STRING:"str", PR_TAG:"tag", PR_TYPE:"typ", prettyPrintOne:F.prettyPrintOne
                = function (a, b, c) {
                ...
                function (a) {
                    function b() {
                        var s;
                        for (var c = F.PR_SHOULD_USE_CONTINUATION ? m.now() + 250 : Infinity;
                            p < d.length && m.now() < c; p++) {
                            var g = d[p], j = g.className;
                            if (v.test(j) && !o.test(j)) {
                                for (var h = !1, e = g.parentNode; e; e = e.parentNode) {
                                    if (l.test(e.tagName)
                                        && e.className && v.test(e.className)) {
                                        h = !0;
                                        break
                                    }
                                }
                                if (!h) {
                                    ...
                                    var j = j.match(n), k;
                                    if (h = !j) {
                                        for (var h = g, e = I, q = h.firstChild; q;
                                            q = q.nextSibling) {
                                            var t = q.nodeType, e = t === 1 ? e ? h : q : t === 3
                                                ? L.test(q.nodeValue) ? h : e : e;
                                        }
                                        h = (k = e === h ? I : e) && u.test(k.tagName)
                                    }
                                    h && (j = k.className.match(n));
                                    j && (j = j[1]);
                                    s = i.test(g.tagName) ? 1 : (h = (h = g.currentStyle) ? h.whiteSpace
                                        : document.defaultView && document.defaultView.getComputedStyle
                                        ? document.defaultView.getComputedStyle(g, null).getPropertyValue("white-space")
                                        : 0) && "pre" === h.substring(0, 3), h = s;
                                    (e = (e = g.className.match(/\blinenums\b(?::(\d+))?/)) ? e[1] && e[1].length
                                        ? +e[1] : !0 : !1) && r(g, e, h);
