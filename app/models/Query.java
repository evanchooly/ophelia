...
public class Query extends MongoModel<Query> {
    ...
    public boolean equals(Object o) {
        ...
        if (bookmark != null ? !bookmark.equals(query.bookmark) : query.bookmark != null) return false;
        if (queryString != null ? !queryString.equals(query.queryString) : query.queryString != null) return false;
